...
impl GameState {
    ...
    pub fn player_victory(&mut self, curr_mob: &mut Mob, player: &mut Player, mob_index: &mut usize) {
    ...
    pub fn proceed_room(&mut self, room_number: &mut i32, mob_index: &mut usize, player: &mut Player) {
